...
/**
 * An activity representing a list of ItemCreatorDisciplines. This activity has
 ...
 * {@link CreatorDisciplineDetailActivity} representing item details. On
 * tablets, the activity presents the list of items and item details
 * side-by-side using two vertical panes.
 * <p>
 * The activity makes heavy use of fragments. The list of items is a
 * {@link CreatorDisciplineListFragment} and the item details (if present)
 * is a {@link CreatorDisciplineDetailFragment}.
 * <p>
 * This activity also implements the required
 * {@link CreatorDisciplineListFragment.Callbacks} interface to listen for
 * item selections.
 */
public class CreatorDisciplineListActivity extends FragmentActivity
		implements CreatorDisciplineListFragment.Callbacks {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_creatordiscipline_list);
	...
	/**
	 * Callback method from {@link CreatorDisciplineListFragment.Callbacks}
