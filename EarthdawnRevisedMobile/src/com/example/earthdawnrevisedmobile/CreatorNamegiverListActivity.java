...
/**
 * An activity representing a list of ItemCreatorNamegivers. This activity has
 ...
 * {@link CreatorNamegiverDetailActivity} representing item details. On
 * tablets, the activity presents the list of items and item details
 * side-by-side using two vertical panes.
 * <p>
 * The activity makes heavy use of fragments. The list of items is a
 * {@link CreatorNamegiverListFragment} and the item details (if present) is
 * a {@link CreatorNamegiverDetailFragment}.
 * <p>
 * This activity also implements the required
 * {@link CreatorNamegiverListFragment.Callbacks} interface to listen for
 * item selections.
 */
public class CreatorNamegiverListActivity extends FragmentActivity
		implements CreatorNamegiverListFragment.Callbacks {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_creatornamegiver_list);
